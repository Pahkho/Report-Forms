...
FROM (
         ...
         FROM stk_assigner_workflow a1
             LEFT JOIN bas_logic_warehouse bl ON a1.logic_warehouse_id = bl.id
             LEFT JOIN bas_shop_use_warehouse bs ON bl.id = bs.logic_warehouse_id
             LEFT JOIN bas_shop shop ON bs.shop_id = shop.id
